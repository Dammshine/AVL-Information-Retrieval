...
SUPPORTING_FILES = FileNodeHelper.c invertedIndexBSTHelper.c invertedIndexRoot.c textQuery.c wordRecord.c BST.c TfIdfNodeHelper.c
...
exmp1/testInvertedIndex: exmp1/testInvertedIndex.c invertedIndex.c $(SUPPORTING_FILES)
	$(CC) $(CNOERR) -o exmp1/testInvertedIndex exmp1/testInvertedIndex.c invertedIndex.c  $(SUPPORTING_FILES) -lm

exmp2/testInvertedIndex: exmp2/testInvertedIndex.c invertedIndex.c $(SUPPORTING_FILES)
	$(CC) $(CNOERR) -o exmp2/testInvertedIndex exmp2/testInvertedIndex.c invertedIndex.c  $(SUPPORTING_FILES) -lm
